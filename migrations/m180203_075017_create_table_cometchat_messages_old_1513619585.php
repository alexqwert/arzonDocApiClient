...
class m180203_075017_create_table_cometchat_messages_old_1513619585 extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%cometchat_messages_old_1513619585}}', [
    ...
    {
        $this->dropTable('{{%cometchat_messages_old_1513619585}}');
    }
}
