...
class m180203_075017_create_table_cometchat_messages_old_1513618025 extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%cometchat_messages_old_1513618025}}', [
    ...
    {
        $this->dropTable('{{%cometchat_messages_old_1513618025}}');
    }
}
